<nav x-data="{ open: false }" class="fixed top-0 left-0 w-screen dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('user.events')" :active="request()->routeIs('user.events')">
                {{ __('Events') }}
            </x-responsive-nav-link>
